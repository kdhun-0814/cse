...
# 1-3. 방 데이터 (6floor.txt 기반 - 601~612 및 시설)
# 1-3. 방 데이터 (6층 호실 - 원본 데이터 복구)
# 1-3. 방 데이터 (6층 호실 - 6floor.txt 원본 좌표 반영)
rooms = {
    "601": (90, 115), "602": (150, 115), "603": (215, 115), "604": (210, 25),
    "휴게실": (150, 25), "그린라운지": (0, 110),
    "606": (-80, 80), "607": (-115, 45), "608": (-145, 15), 
    "609": (-175, -15), "610": (-205, -45), "611": (-235, -75),
    "612": (-265, -105), "613": (-160, -120), "614": (-200, -160),
...
# 파일 저장 코드
# with open("floor_6_path.json", "w", encoding='utf-8') as f:
